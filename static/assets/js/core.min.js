...
var pbmit_sticky_header = function () {
  if (jQuery(".pbmit-header-sticky-yes").length > 0) {
    jQuery("#masthead .pbmit-main-header-area")
      .clone()
      .appendTo(".pbmit-sticky-header");
    jQuery(
      ".pbmit-sticky-header .main-navigation ul, .pbmit-sticky-header .main-navigation ul li, .pbmit-sticky-header .main-navigation ul li a"
    ).removeAttr("id");
    ...
    if (jQuery(".pbmit-main-header-area").hasClass("pbmit-infostack-header")) {
      jQuery(".pbmit-sticky-header .pbmit-header-menu-area").insertAfter(
        ".pbmit-sticky-header .site-branding"
      );
      jQuery(
        ".pbmit-sticky-header .pbmit-header-info, .pbmit-sticky-header .pbmit-mobile-search, .pbmit-sticky-header .nav-menu-toggle"
      ).remove();
    }
  }
  pbmit_flotingbar();
...
var pbmit_sticky_header_class = function () {
  ...
  if (jQuery(window).scrollTop() > offset_px) {
    ...
    jQuery(
      ".pbmit-sticky-header .mega-menu.max-mega-menu.mega-menu-horizontal"
    ).attr("id", "mega-menu-pbminfotech-top");
  } else {
...
var pbmit_menu_span = function () {
  jQuery(
    ".pbmit-max-mega-menu-override #page #site-navigation .mega-menu-wrap>ul>li.mega-menu-item .mega-sub-menu a, .pbmit-navbar ul ul a"
  ).each(function (i, v) {
    jQuery(v).contents().eq(0).wrap('<span class="pbmit-span-wrapper"/>');
  });
};

// jQuery('.pbmit-mobile-menu-bg').hide();
var pbmit_toggleSidebar = function () {
  // jQuery('.pbmit-mobile-menu-bg').show();
  ...
  if (jQuery(".pbmit-navbar > div > .closepanel").length == 0) {
    jQuery(".pbmit-navbar > div").append(
      '<span class="closepanel"><svg class="qodef-svg--close qodef-m" xmlns="http://www.w3.org/2000/svg" width="20.163" height="20.163" viewBox="0 0 26.163 26.163"><rect width="36" height="1" transform="translate(0.707) rotate(45)"></rect><rect width="36" height="1" transform="translate(0 25.456) rotate(-45)"></rect></svg></span>'
    );
    jQuery(
      ".pbmit-navbar > div > .closepanel, .mega-menu-pbminfotech-top .nav-menu-toggle"
    ).on("click", function () {
      // jQuery('.pbmit-mobile-menu-bg').hide();
      jQuery(".pbmit-navbar > div, body, .mega-menu-wrap").toggleClass(
        "active"
      );
    });
    return !1;
...
var pbmit_flotingbar = function () {
  jQuery(".pbmit-nav-menu-toggle").on("click", function () {
    jQuery(
      "body:not(.mega-menu-pbminfotech-top) .floting-bar-wrap"
    ).toggleClass("active");
  });
  if (jQuery(".floting-bar-wrap .closepanel").length == 0) {
    jQuery(".floting-bar-wrap").append(
      '<span class="closepanel"><svg class="qodef-svg--close qodef-m" xmlns="http://www.w3.org/2000/svg" width="26.163" height="26.163" viewBox="0 0 26.163 26.163"><rect width="36" height="1" transform="translate(0.707) rotate(45)"></rect><rect width="36" height="1" transform="translate(0 25.456) rotate(-45)"></rect></svg></span>'
    );
...
function pbmit_wc_cart_page_qty_update() {
  jQuery(document).ajaxComplete(function () {
    if (
      jQuery(".product-quantity .quantity input.input-text.qty").length > 0 &&
      jQuery(".pbmit-cart-wrapper .pbmit-cart-details span.pbmit-cart-count")
        .length > 0
    ) {
      var total_qty = 0;
      jQuery(".product-quantity .quantity input.input-text.qty").each(
        function () {
          total_qty = total_qty + parseInt(jQuery(this).val());
          jQuery(
            ".pbmit-cart-wrapper .pbmit-cart-details span.pbmit-cart-count"
          ).text(total_qty);
        }
      );
      jQuery(".pbmit-cart-wrapper span.woocommerce-Price-amount").html(
        jQuery(".cart_totals .woocommerce-Price-amount > bdi").html()
      );
    }
  });
}
...
var pbmit_staticbox_hover_slide = function () {
  if (typeof Swiper !== "undefined") {
    ...
    jQuery(".pbmit-main-static-slider li").hover(function (e) {
      ...
      pbmit_hover2.slideTo(myindex, 500, !1);
    });
  }
};
  ...
  if (jQuery(".pbmit-progress-wrap path").length > 0) {
    ...
    jQuery(window).on("scroll", function () {
      if (jQuery(this).scrollTop() > offset) {
        ...
        jQuery(".fixUP").addClass("active-progress");
      } else {
        jQuery(".pbmit-progress-wrap").removeClass("active-progress");
        jQuery(".fixUP").removeClass("active-progress");
...
var pbmit_navbar = function () {
  if (!jQuery('ul#pbmit-top-menu > li > a[href="#"]').pbmit_is_bound("click")) {
    jQuery('ul#pbmit-top-menu > li > a[href="#"]').click(function () {
      return !1;
    });
  }
  jQuery(".pbmit-navbar > div > ul li:has(ul)").append(
    "<span class='sub-menu-toggle'><i class='pbmit-base-icon-angle-right'></i></span>"
  );
  ...
  jQuery(".sub-menu-toggle").on("click", function () {
    if (jQuery(this).siblings(".sub-menu, .children").hasClass("show")) {
      ...
      jQuery("i", jQuery(this))
        .removeClass("pbmit-base-icon-up-open-big")
        .addClass("pbmit-base-icon-angle-right");
    } else {
      jQuery(this).siblings(".sub-menu, .children").addClass("show");
      jQuery("i", jQuery(this))
        .removeClass("pbmit-base-icon-angle-right")
        .addClass("pbmit-base-icon-up-open-big");
    }
    return !1;
  });
...
var pbmit_lightbox = function () {
  var i_type = "image";
  jQuery(
    "a.pbmit-lightbox, a.pbmit-lightbox-video, .pbmit-lightbox-video a, .pbmit-lightbox a, .pbmit-gallery-style-1 > a"
  ).each(function () {
    if (
      jQuery(this).hasClass("pbmit-lightbox-video") ||
      jQuery(this)
        .closest(".elementor-element")
        .hasClass("pbmit-lightbox-video")
    ) {
      i_type = "iframe";
    } else {
      i_type = "image";
...
var pbmit_testimonial = function () {
  jQuery(".pbmit-testimonial-active").each(function () {
    ...
    jQuery(".pbminfotech-ele.pbminfotech-ele-testimonial", ele_parent).on(
      "mouseover",
      function () {
        jQuery(
          ".pbminfotech-ele.pbminfotech-ele-testimonial",
          ele_parent
        ).removeClass("pbmit-testimonial-active");
...
var pbmit_center_logo_header_class = function () {
  if (jQuery("#masthead.pbmit-header-style-5 ul#pbmit-top-menu").length > 0) {
    var has_class = jQuery(
      "#masthead.pbmit-header-style-5 ul#pbmit-top-menu > li"
    ).hasClass("pbmit-logo-append");
    if (has_class == !1) {
      var total_li = jQuery(
        "#masthead.pbmit-header-style-5 ul#pbmit-top-menu > li"
      ).length;
      ...
      jQuery(
        "#masthead.pbmit-header-style-5 ul#pbmit-top-menu > li:nth-child(" +
          li +
          ")"
      ).addClass("pbmit-logo-append");
    }
  }
};
...
var pbmit_hover_slide = function () {
  ...
  jQuery(".pbmit-main-hover-slider li").hover(function (e) {
    e.preventDefault();
    var myindex = jQuery(this).index();
    pbmit_hover.slideTo(myindex, 500, !1);
  });
};
...
var pbmit_icon_box_hover_effect = function () {
  jQuery(
    ".pbmit-icon-box-hover-effect .pbmit-element-posts-wrapper .pbmit-ele-miconheading , .pbmit-icon-box-hover-effect .elementor-inner-section .elementor-container .elementor-inner-column:nth-child(2)"
  )
    .eq(0)
    .addClass("pbmit-ihbox-hover-active");
  jQuery(
    ".pbmit-icon-box-hover-effect .pbmit-element-posts-wrapper .pbmit-ele-miconheading , .pbmit-icon-box-hover-effect .elementor-inner-section .elementor-container .elementor-inner-column"
  ).mouseover(function () {
    var main_row = jQuery(this).closest(".pbmit-icon-box-hover-effect");
    jQuery(
      ".pbmit-ele-miconheading , .elementor-inner-column",
      main_row
    ).removeClass("pbmit-ihbox-hover-active");
    jQuery(this).addClass("pbmit-ihbox-hover-active");
  });
};
var pbmit_multi_icon_box_hover_effect = function () {
  jQuery(
    ".pbmit-multi-icon-box-hover-effect .pbmit-miconheading-style-16:nth-child(2), .pbmit-multi-icon-box-hover-effect .pbmit-miconheading-style-24:nth-child(2)"
  ).addClass("pbmit-mihbox-hover-active");
  jQuery(
    ".pbmit-multi-icon-box-hover-effect .pbmit-miconheading-style-16, .pbmit-multi-icon-box-hover-effect .pbmit-miconheading-style-24"
  )
    .mouseover(function () {
      var main_row = jQuery(this).closest(".pbmit-multi-icon-box-hover-effect");
      jQuery(
        ".pbmit-miconheading-style-16, .pbmit-miconheading-style-24",
        main_row
      ).removeClass("pbmit-mihbox-hover-active");
    ...
    .mouseout(function () {
      ...
      jQuery(
        ".pbmit-miconheading-style-16:nth-child(2), .pbmit-miconheading-style-24:nth-child(2)",
        main_row
      ).addClass("pbmit-mihbox-hover-active");
    });
};
var pbmit_carousel = function () {
  if (typeof Swiper !== "undefined") {
    ...
    jQuery(".pbmit-element-viewtype-carousel").each(function () {
      ...
      if (val_dots == !0) {
        jQuery(".pbmit-element-inner", carouselElement).append(
          '<div class="swiper-pagination swiper-pagination-' + x + '"></div>'
        );
      }
      if (val_nav == !0) {
        jQuery(".pbmit-element-inner", carouselElement).append(
      ...
      jQuery(".pbmit-element-posts-wrapper", carouselElement)
        .removeClass("row")
        .removeClass("multi-columns-row");
      jQuery(".pbmit-ele", carouselElement)
      ...
      var pagination_val = !1;
      if (val_dots == !0) {
        pagination_val = { el: ".swiper-pagination-" + x, clickable: !0 };
      }
      if (
        jQuery(this)
          .closest(".elementor-element")
          .hasClass("pbmit-slider-partial-over") &&
        columns == "2"
      ) {
        responsive_items = ["1.5", "1", "1", "1", "1"];
      }
      if (
        jQuery(".pbmit-element-viewtype-carousel-" + x).hasClass(
          "pbmit-element-testimonial-style-4"
        )
      ) {
        responsive_items = ["4.2", "3.0", "2.0", "1.0", "1.0"];
      }
      var swiper_options = {
        createElements: !0,
        loop: loop,
        ...
        breakpoints: {
          1199: { slidesPerView: responsive_items[0] },
          991: { slidesPerView: responsive_items[1] },
          767: { slidesPerView: responsive_items[2] },
          575: { slidesPerView: responsive_items[3] },
          0: { slidesPerView: responsive_items[4] },
        },
      };
...
var pbmit_menu_count = function () {
  if (
    jQuery("ul#pbmit-top-menu > li").length > 0 ||
    jQuery("div#pbmit-top-menu > ul > li").length > 0
  ) {
...
jQuery.fn.pbmit_isInViewport = function () {
  ...
  jQuery(".pbmit-tab-link").on("click", function () {
    if (!jQuery(this).hasClass("pbmit-tab-li-active")) {
      ...
      jQuery(this)
        .parent()
        .parent()
        .find(".pbmit-tab-content")
        .removeClass("pbmit-tab-active");
      jQuery(this)
        .parent()
        .parent()
        .find(".pbmit-tab-content-" + tab_number)
        .addClass("pbmit-tab-active");
    }
  });
  var pbmit_this_tab = "";
  var pbmit_tab_id = "";
  jQuery(".pbmit-tab-content-title").on("click", function (e) {
    e.preventDefault();
    parent_ele = jQuery(this).closest(".pbminfotech-ele-tab-menu");
    tab_number = jQuery(this).data("pbmit-tab");
    if (jQuery(window).width() < 768) {
      setTimeout(function () {
        pbmit_this_tab =
          '.pbmit-tab-content-title[data-pbmit-tab="' + tab_number + '"]';
        var offset = 20;
        if (jQuery("#wpadminbar").length > 0) {
        ...
        jQuery("html, body").animate(
          {
            scrollTop: jQuery(pbmit_this_tab, parent_ele).offset().top - offset,
          },
          200,
          "linear"
        );
    ...
    jQuery(this)
      .closest(".pbmit-tabs")
      .find('li.pbmit-tab-link[data-pbmit-tab="' + tab_number + '"]')
      .trigger("click");
  });
};
    ...
    jQuery(".pbmit-element-viewtype-masonry").each(function () {
      ...
      if (jQuery(main_ele).hasClass("pbmit-infinite-scroll-yes")) {
        ...
        if (jQuery(main_ele).hasClass("pbmit-infinite-scroll-button-yes")) {
          ...
          $grid.infiniteScroll({
            path:
              pbmit_js_variables.ajaxurl +
              "?action=pbmit_infinite_scroll&page_no={{#}}&nonce=" +
              pbmit_js_variables.ajaxnonce +
              url_attributes,
            checkLastPage: !1,
          ...
          $grid.on(
            ...
            function (event, body, path, items, response) {
              ...
              if (x >= totalpagination) {
                ...
                jQuery(".pbmit-infinite-loader", main_ele).addClass(
...
var pbmit_search_results = function () {
  if (
    jQuery(".pbmit-search-results-main-wrapper").length > 0 &&
    jQuery(".pbmit-search-result-tab-links").length > 0
  ) {
...
var pbmit_stepanimation = function () {
  ...
  function animateSteps(m) {
    jQuery("#stepsAnimation")
      .find(".step")
      .each(function (index) {
        jQuery(this).removeClass("step-animate");
      });
    jQuery("#stepsAnimation .multi-columns-row")
      .find(".step")
      .eq(m)
      .addClass("step-animate");
  }
    ...
    jQuery(this).waypoint(
      function (direction) {
        ...
        if (!$progressbar.hasClass("completed")) {
          $progressbar
            .css("width", $progressbar.data("max") + "%")
            .addClass("completed");
        }
      },
      { offset: "99%" }
...
var pbmit_validate = function () {
  jQuery("#commentform").submit(function (event) {
    ...
    if (jQuery("#email").length > 0) {
      if (!jQuery("#email").val()) {
        jQuery(
          ".comment-form-email .pbmit-form-error.pbmit-empty-email"
        ).show();
        error = !0;
      } else {
        ...
        if (valid_email != !0) {
          jQuery(
            ".comment-form-email .pbmit-form-error.pbmit-invalid-email"
          ).show();
          error = !0;
        }
      }
...
var pbmit_image_correction = function () {
  jQuery(".site-content-wrap img").each(function () {
    ...
    if (
      typeof ele_width === "undefined" ||
      ele_width === !1 ||
      typeof ele_height === "undefined" ||
      ele_height === !1
    ) {
      jQuery("<img/>")
        .attr("src", ele_url)
...
function pbmit_mousehover_tooltip() {
  jQuery(
    "<div id='pbmit-portfolio-cursor'><div class='pbmit-tooltip-content'></div></div>"
  ).appendTo("body");
  var pbmit_text = jQuery(
...
var pbmit_marquee = function () {
  if (typeof Swiper !== "undefined") {
    ...
    jQuery(".pbminfotech-element-marquee-effect").each(function () {
      ...
      if (!reverse_direction) reverse_direction = !1;
      var swiper = new Swiper(
        ".pbmit-marquee-effect-section-" + x + " .pbmit-marquee-container",
        {
          createElements: !0,
          spaceBetween: 0,
          centeredSlides: !0,
      ...
      var swiper = new Swiper(
        ".pbmit-marquee-effect-section-" +
          x +
          " .pbmit-marquee-container.pbmit-tag-bottom",
        {
          spaceBetween: 0,
          centeredSlides: !0,
          speed: 12000,
...
var pbmit_timelinehover = function () {
  jQuery(".pbmit-timeline ol li div.pbmit-content")
    .mouseover(function () {
...
var pbmit_bmi_calculator = function () {
  jQuery(".pbmit-bmi-calc-type").on("change", function () {
    var main = jQuery(this).closest(".pbmit-bmi-cal-wrapper");
    var val = jQuery(".pbmit-bmi-calc-type:checked", main).val();
    if (val == "imperial") {
      jQuery(".pbmit-bmi-calc-imperial", main).show();
      jQuery(".pbmit-bmi-calc-metric", main).hide();
    } else {
      jQuery(".pbmit-bmi-calc-imperial", main).hide();
      jQuery(".pbmit-bmi-calc-metric", main).show();
    }
  });
  jQuery(".pbmit-button a").on("click", function (e) {
    e.preventDefault();
    return !1;
  });
  jQuery(
    ".pbmit-bmi-calc-imperial input.pbmit-input, .pbmit-bmi-calc-metric input.pbmit-input"
  ).on("keyup", function () {
    var main = jQuery(this).closest(".pbmit-bmi-cal-wrapper");
    var type = "";
    if (jQuery(this).closest(".pbmit-bmi-calc-metric").length > 0) {
      type = "metric";
      var result_div = jQuery(".pbmit-bmi-result-metric", main);
      var bmi_num_div = jQuery(".pbmit-bmi-result-metric-bmi > span", main);
      var height = jQuery(".pbmit-metric-cm", main).val() / 100;
      var weight = jQuery(".pbmit-metric-kg", main).val();
      var bmi = weight / Math.pow(height, 2);
    } else {
      type = "imperial";
      var result_div = jQuery(".pbmit-bmi-result-imperial", main);
      var bmi_num_div = jQuery(".pbmit-bmi-result-imperial-bmi > span", main);
      var imperial_feet = jQuery(".pbmit-imperial-feet", main).val();
      var imperial_inch = jQuery(".pbmit-imperial-inch", main).val();
      var imperial_lbs = jQuery(".pbmit-imperial-lbs", main).val();
    ...
    if (bmi < 16) {
      ...
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-1", main).show();
    } else if (bmi < 17) {
      bmi_style = "bg-warning text-dark";
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-2", main).show();
    } else if (bmi < 18.5) {
      bmi_style = "bg-info text-white";
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-3", main).show();
    } else if (bmi < 25) {
      bmi_style = "bg-success text-white";
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-4", main).show();
    } else if (bmi < 30) {
      bmi_style = "bg-info text-white";
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-5", main).show();
    } else if (bmi < 35) {
      bmi_style = "bg-warning text-dark";
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-6", main).show();
    } else if (bmi < 40) {
      bmi_style = "bg-warning text-dark";
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-7", main).show();
    } else {
      bmi_style = "bg-danger text-white";
      jQuery(".pbmit-bmi-result-" + type + "-cat", main).hide();
      jQuery(".pbmit-bmi-result-" + type + "-cat-8", main).show();
    }
    if (
      (type == "metric" &&
        jQuery(".pbmit-metric-cm", main).val() != "" &&
        jQuery(".pbmit-metric-kg", main).val() != "") ||
      (type == "imperial" &&
        jQuery(".pbmit-imperial-feet", main).val() != "" &&
        jQuery(".pbmit-imperial-inch", main).val() != "" &&
        jQuery(".pbmit-imperial-lbs", main).val() != "")
    ) {
      jQuery(result_div)
        .removeClass(
          "bg-success bg-danger bg-warning bg-info text-white text-dark pbmit-hide"
        )
        .addClass(bmi_style)
        .show();
    } else {
...
var pbmit_footer_position = function () {
  if (!jQuery("body").hasClass("elementor-editor-active")) {
    console.log("Found: elementor-editor-active");
    jQuery("footer#colophon").css({ position: "", width: "", bottom: "" });
    ...
    console.log("NOT Found: elementor-editor-active");
  }
};
